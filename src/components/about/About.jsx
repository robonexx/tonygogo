...
<br/>
Originally from Watts, California, Tony Go Go started doing a crazy dance called Campbellocking, with his friends from High School. The three of them went to perform on  Soul Train and then formed a group called the Go Go Brothers. While dancing with his  partners (James “ OG Skeeter Rabbit” Higgins, Edwin “Buddy GoGo”  Lombard, and Kevin YoYo ) they formed another group by the name of Creative Generation - boy did they spread the love and the funk! Partners in that group were Arnetta Johnson, Lorna Dune, Greg Cambellock Jr, Jimmy Scooby-Doo Foster and Tony’s fellow GoGo brothers ... But most of you remember Tony GoGo as a member of the Original Lockers with Don Campbell, Fluky Luke, Mr. Penguine, Shabba-Doo, and Slim The Robot.
          </p>
